...
echo Launcher options: --nodeos \"--plugin core_net::wallet_api_plugin\" $launcherOpts
programs/eosio-launcher/eosio-launcher --nodeos "--plugin core_net::wallet_api_plugin" $launcherOpts
sleep 7
