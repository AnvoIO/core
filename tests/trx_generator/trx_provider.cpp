...
namespace core_net::testing {
   ...
   fc::time_point provider_connection::get_trx_ack_time(const core_net::chain::transaction_id_type& trx_id) {
   ...
   void provider_connection::trx_acknowledged(const core_net::chain::transaction_id_type& trx_id,
   ...
   acked_trx_trace_info p2p_connection::get_acked_trx_trace_info(const core_net::chain::transaction_id_type& trx_id) {
      return {};
   }
   ...
   void http_connection::record_trx_info(const core_net::chain::transaction_id_type& trx_id, uint32_t block_num,
   ...
   acked_trx_trace_info http_connection::get_acked_trx_trace_info(const core_net::chain::transaction_id_type& trx_id) {
