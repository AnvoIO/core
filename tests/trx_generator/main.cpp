...
int main(int argc, char** argv) {
   ...
   try {
      ...
      if(chain_id_in.empty()) {
         ...
         trx_gen_base_config._chain_id = core_net::chain::chain_id_type(chain_id_in);
      }
      ...
      if(lib_id_str.empty()) {
         ...
         trx_gen_base_config._last_irr_block_id = fc::variant(lib_id_str).as<core_net::chain::block_id_type>();
      }
      ...
      if(contract_owner_account_in.empty()) {
         ...
         trx_gen_base_config._contract_owner_account = core_net::chain::name(contract_owner_account_in);
      }
