...
try:
    ...
    specificArgs = {
        '0': '--agent-name node-00 --p2p-listen-endpoint 0.0.0.0:9876 --p2p-listen-endpoint 0.0.0.0:9779 --p2p-server-address ext-ip0:20000 --p2p-server-address ext-ip1:20001 --plugin core_net::net_api_plugin',
        '2': '--agent-name node-02 --p2p-peer-address localhost:9779 --plugin core_net::net_api_plugin',
        '4': '--agent-name node-04 --p2p-peer-address localhost:9876 --plugin core_net::net_api_plugin',
    }
