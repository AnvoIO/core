...
BOOST_AUTO_TEST_SUITE(eosvmoc_platform_tests)
...
#ifdef CORE_NET_VM_OC_RUNTIME_ENABLED
   auto stride_val = core_net::chain::eosvmoc::memory::stride;
   BOOST_CHECK_EQUAL(stride_val, (size_t)CORE_NET_VM_OC_MEMORY_STRIDE);
   auto cb_sum = (int64_t)core_net::chain::eosvmoc::memory::cb_offset + CORE_NET_VM_OC_CONTROL_BLOCK_OFFSET;
