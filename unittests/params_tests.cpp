...
#include <core_net/testing/tester.hpp>       /* tester */
#include <core_net/chain/exceptions.hpp>     /* config_parse_error */
...
public:
   ...
   void setup(){
      ...
      set_code(config::system_account_name, core_net::testing::test_contracts::params_test_wasm());
      set_abi(config::system_account_name, core_net::testing::test_contracts::params_test_abi());
      produce_block();
   }
