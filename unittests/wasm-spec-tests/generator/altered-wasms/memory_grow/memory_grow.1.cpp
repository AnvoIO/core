...
extern "C" {
   ...
   void sub_apply_0() {
      ...
      core_net::check(x4 == (int32_t)2, "_grow fail 4");

      int32_t x5 = _grow((int32_t)523);
      core_net::check(x5 == (int32_t)4, "_grow fail 5");

      int32_t x6 = _grow((int32_t)1);
      core_net::check(x6 == (int32_t)527, "_grow fail 6");

      int32_t x7 = _grow((int32_t)0);
      core_net::check(x7 == (int32_t)528, "_grow fail 7");
   }
