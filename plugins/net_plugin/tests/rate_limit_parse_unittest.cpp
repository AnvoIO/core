...
BOOST_AUTO_TEST_CASE(test_parse_rate_limit) {
   ...
   size_t which = 0;
   auto [listen_addr, block_sync_rate_limit] = core_net::net_utils::parse_listen_address(p2p_addresses.at(which++));
   BOOST_CHECK_EQUAL(listen_addr, "0.0.0.0:9876");
   BOOST_CHECK_EQUAL(block_sync_rate_limit, 0u);
   std::tie(listen_addr, block_sync_rate_limit) = core_net::net_utils::parse_listen_address(p2p_addresses.at(which++));
   ...
   BOOST_CHECK_EQUAL(block_sync_rate_limit, 250000u);
   BOOST_CHECK_EXCEPTION(core_net::net_utils::parse_listen_address(p2p_addresses.at(which++)), core_net::chain::plugin_config_exception,
                         [](const core_net::chain::plugin_config_exception& e)
...
BOOST_AUTO_TEST_CASE(test_split_host_port_type) {
   ...
   size_t which = 0;
   auto [host, port, type] = core_net::net_utils::split_host_port_type(p2p_addresses.at(which++));
   BOOST_CHECK_EQUAL(host, "0.0.0.0");
   BOOST_CHECK_EQUAL(port, "9876");
   BOOST_CHECK_EQUAL(type, "");
   std::tie(host, port, type) = core_net::net_utils::split_host_port_type(p2p_addresses.at(which++));
   BOOST_CHECK_EQUAL(host, "0.0.0.0");
