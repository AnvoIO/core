...
core_net::vm::guarded_vector<uint8_t>* find_export_name(core_net::vm::module& mod, uint32_t idx) {
   ...
   for(uint32_t i = 0; i < mod.exports.size(); ++i) {
      if(mod.exports[i].index == idx && mod.exports[i].kind == core_net::vm::Function) {
