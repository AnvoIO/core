...
struct static_options_3 {
   static constexpr std::uint32_t core_net_max_nested_structures = 3;
};
struct static_options_4 {
   static constexpr std::uint32_t core_net_max_nested_structures = 4;
};
struct dynamic_options {
   std::uint32_t core_net_max_nested_structures;
};

}

BACKEND_TEST_CASE("Test core_net_max_nested_structures default", "[core_net_max_nested_structures_test]") {
   using backend_t = backend<std::nullptr_t, TestType>;
   backend_t backend(nested_4_wasm, &wa);
   backend_t backend2(nested_4_wasm_2, &wa);
}

BACKEND_TEST_CASE("Test core_net_max_nested_structures unlimited", "[core_net_max_nested_structures_test]") {
   using backend_t = backend<std::nullptr_t, TestType, empty_options>;
   backend_t backend(nested_4_wasm, &wa);
   backend_t backend2(nested_4_wasm_2, &wa);
}

BACKEND_TEST_CASE("Test core_net_max_nested_structures static fail", "[core_net_max_nested_structures_test]") {
...
BACKEND_TEST_CASE("Test core_net_max_nested_structures static pass", "[core_net_max_nested_structures_test]") {
   using backend_t = backend<std::nullptr_t, TestType, static_options_4>;
   backend_t backend(nested_4_wasm, &wa);
   backend_t backend2(nested_4_wasm_2, &wa);
}

BACKEND_TEST_CASE("Test core_net_max_nested_structures dynamic fail", "[core_net_max_nested_structures_test]") {
...
BACKEND_TEST_CASE("Test core_net_max_nested_structures dynamic pass", "[core_net_max_nested_structures_test]") {
   using backend_t = backend<std::nullptr_t, TestType, dynamic_options>;
