...
CHAINBASE_SET_INDEX_TYPE(core_net::chain::permission_link_object, core_net::chain::permission_link_index)

FC_REFLECT(core_net::chain::permission_link_object, (account)(code)(message_type)(required_permission))
