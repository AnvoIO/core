...
FC_REFLECT(core_net::chain::eosvmoc::code_compilation_result_message, (start)(apply_offset)(table_offset)(starting_memory_pages)(initdata_prologue_size)(queued_time))
