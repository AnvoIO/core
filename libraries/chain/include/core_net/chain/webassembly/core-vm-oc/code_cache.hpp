...
class code_cache_base {
   public:
      code_cache_base(const std::filesystem::path& data_dir, const corevmoc::config& corevmoc_config, const chainbase::database& db);
      ~code_cache_base();
   ...
   protected:
      ...
      corevmoc::config            _corevmoc_config;
...
class code_cache_async : public code_cache_base {
   public:
      ...
      code_cache_async(const std::filesystem::path& data_dir, const corevmoc::config& corevmoc_config,
