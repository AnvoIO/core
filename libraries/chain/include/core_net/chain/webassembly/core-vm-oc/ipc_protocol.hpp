...
struct compile_wasm_message {
   ...
   std::optional<corevmoc::subjective_compile_limits> limits;
...
using corevmoc_message = std::variant<initialize_message,
...
FC_REFLECT(core_net::chain::corevmoc::initialize_message, )
FC_REFLECT(core_net::chain::corevmoc::initalize_response_message, (error_message))
FC_REFLECT(core_net::chain::corevmoc::code_tuple, (code_id)(vm_version))
FC_REFLECT(core_net::chain::corevmoc::compile_wasm_message, (log_level)(receiver)(code)(queued_time)(limits))
FC_REFLECT(core_net::chain::corevmoc::evict_wasms_message, (codes))
FC_REFLECT(core_net::chain::corevmoc::code_compilation_result_message, (start)(apply_offset)(table_offset)(starting_memory_pages)(initdata_prologue_size)(queued_time))
FC_REFLECT(core_net::chain::corevmoc::compilation_result_unknownfailure, )
FC_REFLECT(core_net::chain::corevmoc::compilation_result_toofull, )
FC_REFLECT(core_net::chain::corevmoc::wasm_compilation_result_message, (code)(result)(cache_free_bytes)(queued_time))
