...
} // ns core_net::chain::corevmoc::detail

inline constexpr auto get_intrinsic_table() {
   return detail::generate_table(
      "corevmoc_internal.unreachable",
      "corevmoc_internal.grow_memory",
      "corevmoc_internal.div0_or_overflow",
      "corevmoc_internal.indirect_call_mismatch",
      "corevmoc_internal.indirect_call_oob",
      "corevmoc_internal.depth_assert",
      "core_net_injection.call_depth_assert",  //now unused; left for purposes of not upsetting existing code mappings
      "core_net_injection.checktime",          //now unused; left for purposes of not upsetting existing code mappings
      "env.__ashlti3",
      "env.__ashrti3",
      "env.__lshlti3",
      "env.__lshrti3",
      ...
      "env.abort",
      "env.core_net_assert",
      "env.core_net_assert_message",
      "env.core_net_assert_code",
      "env.core_net_exit",
      ...
      "env.memcmp",
      "env.memset",
      "core_net_injection._core_net_f32_add",
      "core_net_injection._core_net_f32_sub",
      "core_net_injection._core_net_f32_mul",
      "core_net_injection._core_net_f32_div",
      "core_net_injection._core_net_f32_min",
      "core_net_injection._core_net_f32_max",
      "core_net_injection._core_net_f32_copysign",
      "core_net_injection._core_net_f32_abs",
      "core_net_injection._core_net_f32_neg",
      "core_net_injection._core_net_f32_sqrt",
      "core_net_injection._core_net_f32_ceil",
      "core_net_injection._core_net_f32_floor",
      "core_net_injection._core_net_f32_trunc",
      "core_net_injection._core_net_f32_nearest",
      "core_net_injection._core_net_f32_eq",
      "core_net_injection._core_net_f32_ne",
      "core_net_injection._core_net_f32_lt",
      "core_net_injection._core_net_f32_le",
      "core_net_injection._core_net_f32_gt",
      "core_net_injection._core_net_f32_ge",
      "core_net_injection._core_net_f64_add",
      "core_net_injection._core_net_f64_sub",
      "core_net_injection._core_net_f64_mul",
      "core_net_injection._core_net_f64_div",
      "core_net_injection._core_net_f64_min",
      "core_net_injection._core_net_f64_max",
      "core_net_injection._core_net_f64_copysign",
      "core_net_injection._core_net_f64_abs",
      "core_net_injection._core_net_f64_neg",
      "core_net_injection._core_net_f64_sqrt",
      "core_net_injection._core_net_f64_ceil",
      "core_net_injection._core_net_f64_floor",
      "core_net_injection._core_net_f64_trunc",
      "core_net_injection._core_net_f64_nearest",
      "core_net_injection._core_net_f64_eq",
      "core_net_injection._core_net_f64_ne",
      "core_net_injection._core_net_f64_lt",
      "core_net_injection._core_net_f64_le",
      "core_net_injection._core_net_f64_gt",
      "core_net_injection._core_net_f64_ge",
      "core_net_injection._core_net_f32_promote",
      "core_net_injection._core_net_f64_demote",
      "core_net_injection._core_net_f32_trunc_i32s",
      "core_net_injection._core_net_f64_trunc_i32s",
      "core_net_injection._core_net_f32_trunc_i32u",
      "core_net_injection._core_net_f64_trunc_i32u",
      "core_net_injection._core_net_f32_trunc_i64s",
      "core_net_injection._core_net_f64_trunc_i64s",
      "core_net_injection._core_net_f32_trunc_i64u",
      "core_net_injection._core_net_f64_trunc_i64u",
      "core_net_injection._core_net_i32_to_f32",
      "core_net_injection._core_net_i64_to_f32",
      "core_net_injection._core_net_ui32_to_f32",
      "core_net_injection._core_net_ui64_to_f32",
      "core_net_injection._core_net_i32_to_f64",
      "core_net_injection._core_net_i64_to_f64",
      "core_net_injection._core_net_ui32_to_f64",
      "core_net_injection._core_net_ui64_to_f64",
      ...
      "env.bls_fp_exp",
      "env.set_finalizers",
      "corevmoc_internal.check_memcpy_params",
