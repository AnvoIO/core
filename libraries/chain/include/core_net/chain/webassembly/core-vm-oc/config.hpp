...
struct subjective_compile_limits {
   ...
   // in the tests in unittests/corevmoc_limits_tests.cpp.
...
inline DS& operator>>(DS& ds, core_net::chain::corevmoc::subjective_compile_limits& cl) {
...
template <typename DS>
inline DS& operator<<(DS& ds, const core_net::chain::corevmoc::subjective_compile_limits& cl) {
...
FC_REFLECT(core_net::chain::corevmoc::config, (cache_size)(threads)(non_whitelisted_limits))