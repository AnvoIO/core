...
CHAINBASE_SET_INDEX_TYPE(core_net::chain::generated_transaction_object, core_net::chain::generated_transaction_multi_index)

FC_REFLECT(core_net::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))
