...
void validate(const bytes& code, const whitelisted_intrinsics_type& intrinsics) {
   ...
   try {
      ...
      for(std::uint32_t i = 0; i < imports.size(); ++i) {
         CORE_ASSERT(std::string_view((char*)imports[i].module_str.raw(), imports[i].module_str.size()) == "env" &&
      ...
      CORE_THROW(wasm_serialization_error, e.detail());
   }
}

void validate( const bytes& code, const wasm_config& cfg, const whitelisted_intrinsics_type& intrinsics ) {
   CORE_ASSERT(code.size() <= cfg.max_module_bytes, wasm_serialization_error, "Code too large");
   wasm_code_ptr code_ptr((uint8_t*)code.data(), code.size());
   try {
      ...
      CORE_ASSERT(apply_idx < std::numeric_limits<uint32_t>::max(), wasm_serialization_error, "apply not exported");
      const vm::func_type& apply_type = bkend.get_module().get_function_type(apply_idx);
      CORE_ASSERT((apply_type == vm::host_function{{vm::i64, vm::i64, vm::i64}, {}}), wasm_serialization_error, "apply has wrong type");
   } catch(vm::exception& e) {
      CORE_THROW(wasm_serialization_error, e.detail());
   }
}
...
// softfloat api
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_add);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_sub);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_div);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_mul);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_min);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_max);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_copysign);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_abs);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_neg);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_sqrt);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_ceil);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_floor);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_trunc);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_nearest);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_eq);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_ne);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_lt);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_le);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_gt);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_ge);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_add);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_sub);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_div);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_mul);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_min);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_max);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_copysign);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_abs);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_neg);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_sqrt);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_ceil);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_floor);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_trunc);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_nearest);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_eq);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_ne);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_lt);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_le);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_gt);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_ge);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_promote);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_demote);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_trunc_i32s);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_trunc_i32s);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_trunc_i32u);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_trunc_i32u);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_trunc_i64s);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_trunc_i64s);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f32_trunc_i64u);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_f64_trunc_i64u);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_i32_to_f32);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_i64_to_f32);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_ui32_to_f32);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_ui64_to_f32);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_i32_to_f64);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_i64_to_f64);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_ui32_to_f64);
REGISTER_INJECTED_HOST_FUNCTION(_core_net_ui64_to_f64);
