...
namespace Serialization
{
	...
	{ 
      if ( numBytes < core_net::chain::wasm_constraints::wasm_page_size || !WASM::check_limits)
	...
	{
      constexpr size_t max_size = core_net::chain::wasm_constraints::maximum_func_local_bytes;
